...
st.write("The Ceaser Cipher App allows you to encrypt normal text by shifting the values. You can shift values from 1-25, but 5 is the default shift value. Press the Encrypt Now! button to get your encryption when you're done. But, if you want to decrypt your text, click the Decrypt Now! button.")
...
if st.button("Decrypt Now!"):
    if text:
        decrypted_text = caesar_decrypt(text, -shift)  # Use negative shift for decryption
