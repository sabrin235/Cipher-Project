...
st.write("The Ceaser Cipher App allows you to encrypt normal text by shifting the values. You can shift values from 1-25, but 5 is the default shift value. When you're done, press the Encrypt Now! button to get your encryption.")
